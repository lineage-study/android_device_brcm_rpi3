...
if [ -f $IMGNAME ]; then
	...
	cp $OUTDIR/obj/KERNEL_OBJ/arch/arm/boot/dts/bcm2710-rpi-3-b.dtb sdcard/boot
	cp $OUTDIR/obj/KERNEL_OBJ/arch/arm/boot/dts/bcm2710-rpi-3-b-plus.dtb sdcard/boot
	cp $OUTDIR/obj/KERNEL_OBJ/arch/arm/boot/dts/overlays/*.dtbo sdcard/boot/overlays
	cp ../../../kernel/brcm/rpi-4.19/arch/arm/boot/dts/overlays/README sdcard/boot/overlays
